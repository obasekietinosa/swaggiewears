@extends('admin.app')
@section('styles')
    <link rel="stylesheet" type="text/css" href="{{ asset('admin/js/plugins/dropzone/dist/min/dropzone.min.css') }}"/>
@endsection
...
@push('scripts')
    ...
    <script type="text/javascript" src="{{ asset('admin/js/plugins/dropzone/dist/min/dropzone.min.js') }}"></script>
